...
class Servicios extends React.Component {
    ...
    render() {
        const {servicios} = this.props.datos;
                        ...
                        <div className="section-head">
                            <div className="mt-separator-outer separator-center servipetrol">
                                <div className="mt-separator">
                                    <h2 className="text-uppercase sep-line-one "><span className="font-weight-300 text-primary colorservipetrol">Nuestros</span> Servicios</h2>
                                </div>
                            </div>
                        </div>
                                ...
                                {servicios?.map((item, index) => (
                                    <div key={index} className="col-md-4 col-sm-6">
                                        <div className="mt-icon-box-wraper  p-a30 center m-b30 box-shadow bg-white">
                                            <div className="mt-icon-box-sm bgservipetrol inline-icon text-primary  m-b20 radius bg-primary  scale-in-center bg-moving" style={{ backgroundImage: 'url(' + img2.default + ')' }}>
