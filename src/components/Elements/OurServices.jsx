...
const services = [
    ...
    {
        count: 3,
        title: 'Tratamiento técnico "IN SITU"',
        slug: 'precalentamiento-de-soldadura',
                        ...
                        <div className="Service-half-top p-t80  bg-dark bg-moving" style={{ backgroundImage: 'url(' + img1.default + ')' }}>
                            <div className="container">
                                ...
                                <div className="section-head text-white">
                                    ...
                                    <h3>Estos son algunos de nuestros servicios más populares.</h3>
                                </div>
                                {/* TITLE END */}
                            </div>
                        </div>
                                            ...
                                            <div className="mt-icon-box-wraper m-b30">
                                                <div className="relative icon-count-2 bg-gray p-a30 p-tb50">
                                                    ...
                                                    <div className="icon-content">
                                                        ...
                                                        <NavLink to={"/categorias/"+item.slug} className="site-button-link" data-hover="Read More">Read More <i className="fa fa-angle-right arrow-animation" /></NavLink>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
