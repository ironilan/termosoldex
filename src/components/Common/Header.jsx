                            ...
                            <div className="row">
                                <div className="mt-topbar-left clearfix">
                                    <ul className="list-unstyled e-p-bx pull-right">
                                        <li><i className="fa fa-envelope" /> {this.state.email}</li>
                                        <li><i className="fa fa-phone" />(51) {this.state.cellphone}</li>
                                        <li><i className="fa fa-mobile" />(51) {this.state.whatsapp}</li>
                                    </ul>
                                </div>
                            ...
                            <div className="container">
                                <div className="logo-header">
                                    <div className="logo-header-inner logo-header-one">
                                        <NavLink to={"/"}>
                                            <img src={this.state.logoHeader} alt="Shapen" />
                                        </NavLink>
                                    </div>
                                </div>
                                {/* NAV Toggle Button */}
                                    ...
                                    <NavLink to={"#"} className="contact_close" onClick={this.handleQuoteToggle}>×</NavLink>
                                        <div className="contact-nav-form p-a30">
                                            <div className="contact-info   m-b30">
                                                <div className="mt-icon-box-wraper center p-b30">
                                                    ...
                                                    <div className="icon-content">
                                                        <h5 className="m-t0 font-weight-500">Celular</h5>
                                                        <p>(51) {this.state.cellphone}</p>
                                                    </div>
                                                </div>
                                                <div className="mt-icon-box-wraper center p-b30">
                                            ...
                                            <div className="text-center">
                                                <h4 className="font-weight-600">©  2021 Termosoldex</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
